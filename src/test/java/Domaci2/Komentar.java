...
import java.time.Duration;
         ...
         public class Komentar {
            ...
            comment.sendKeys("Ovde je prelepo, jedva cekam novi cas");
            driver.findElement(By.xpath("/html/body/div/main/div[5]/div[3]/div[3]/form/p[3]/input")).sendKeys("Marko Markovic iz Nemacke");
            driver.findElement(By.xpath("/html/body/div/main/div[5]/div[3]/div[3]/form/p[4]/input")). sendKeys("markomarkovic@yahoo.com");
